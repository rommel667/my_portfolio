                                ...
                                >
                                    ...
                                    <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                        <ul className="text-lg justify-center">
                                            <li >
                                                <Link href="#projects">
                                                    <a onClick={() => setShow(false)} className="hover:text-gray-400">Projects</a>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link href="#tech">
                                                    <a onClick={() => setShow(false)} className="hover:text-gray-400">Technologies</a>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link href="#about">
                                                    <a onClick={() => setShow(false)} className="hover:text-gray-400">About</a>
                                                </Link>
                                            </li>
                                        </ul>
                                    </Disclosure.Panel>
